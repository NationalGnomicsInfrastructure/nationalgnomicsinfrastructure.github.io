...
- Global styles — all CSS lives in `src/styles/global.css`; no CSS modules or component-scoped styles. Inline `style=` attributes are used heavily within `.astro` files.
